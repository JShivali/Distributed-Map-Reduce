...
# mappercount redcount inputloc mapperfnloc reducerfnloc outputloc
   ;;
   "mapper-instance") java -jar /usr/app6/Distributed-Map-Reduce/Outputs/WordMapperProject.jar $MAPPER_NAME $KV_STORE_IP $OUTPUT_FILE_LOC $INPUT_FILE_LOC $REDUCER_COUNT ;;
